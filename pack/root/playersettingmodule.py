...
def __InitData():
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_FIRST_KILL, "", "d:/ymir work/medal_of_honor/first_kill.mse")
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_DOUBLE_KILL, "", "d:/ymir work/medal_of_honor/double_kill.mse")
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_TRIPLE_KILL, "", "d:/ymir work/medal_of_honor/triple_kill.mse")
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_QUADRA_KILL, "", "d:/ymir work/medal_of_honor/quadra_kill.mse")
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_PENTA_KILL, "", "d:/ymir work/medal_of_honor/penta_kill.mse")
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_HEXA_KILL, "", "d:/ymir work/medal_of_honor/hexa_kill.mse")
...
def __LoadGameEffect():
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+22, "Bip01", "D:/ymir work/pc/common/effect/armor/v1/blau.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+23, "Bip01", "D:/ymir work/pc/common/effect/armor/v1/grun.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+24, "Bip01", "D:/ymir work/pc/common/effect/armor/v1/orange.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+25, "Bip01", "D:/ymir work/pc/common/effect/armor/v1/rot.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+26, "Bip01", "D:/ymir work/pc/common/effect/armor/v1/violett.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 27, "PART_WEAPON", "d:/ymir work/effect/weapon/arma1.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 28, "PART_WEAPON", "d:/ymir work/effect/weapon/arma2.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 29, "PART_WEAPON_LEFT", "d:/ymir work/effect/weapon/arma3.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 30, "PART_WEAPON", "d:/ymir work/effect/weapon/lycan.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 31, "PART_WEAPON_LEFT", "d:/ymir work/effect/weapon/lycan.mse")	
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED + 32, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-5-1.mse")
