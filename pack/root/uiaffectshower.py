...
class AffectShower(ui.Window):
	...
	AFFECT_DATA_DICT =	{
			...
			chr.NEW_AFFECT_FIRST_KILL : (localeInfo.TOOLTIP_FIRST_KILL, "d:/ymir work/ui/pattern/medals/1.dds",),
			chr.NEW_AFFECT_DOUBLE_KILL : (localeInfo.TOOLTIP_DOUBLE_KILL, "d:/ymir work/ui/pattern/medals/2.dds",),
			chr.NEW_AFFECT_TRIPLE_KILL : (localeInfo.TOOLTIP_TRIPLE_KILL, "d:/ymir work/ui/pattern/medals/3.dds",),
			chr.NEW_AFFECT_QUADRA_KILL : (localeInfo.TOOLTIP_QUADRA_KILL, "d:/ymir work/ui/pattern/medals/4.dds",),
			chr.NEW_AFFECT_PENTA_KILL : (localeInfo.TOOLTIP_PENTA_KILL, "d:/ymir work/ui/pattern/medals/5.dds",),
			chr.NEW_AFFECT_HEXA_KILL : (localeInfo.TOOLTIP_HEXA_KILL, "d:/ymir work/ui/pattern/medals/6.dds",),
