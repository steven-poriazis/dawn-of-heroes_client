...
window = {
	...
	(
		...
		{ 
			"name":"AchievementButton", "type" : "button",  "x" : 5, "y" : SCREEN_HEIGHT-200, "default_image" : "d:/ymir work/ui/game/windows/Party_Exit_01.sub", "over_image" : "d:/ymir work/ui/game/windows/Party_Exit_02.sub", "down_image" : "d:/ymir work/ui/game/windows/Party_Exit_03.sub",
			"children" : 
			(
				{ "name":"AchievementText", "type":"text", "x": 16, "y": 40, "text": "Titluri !",  "color" : 0xff57ff14, "text_horizontal_align":"center" },	
			),
		},
		{
			"name" : "GiftIcon",
